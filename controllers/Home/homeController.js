...
const queryProducts = require("../../utils/queryProducts.js");
    ...
    query_products = async (req, res) => {
        ...
        try {
            const products = await productModel.find({}).sort({
             ...
             const totalProduct = new queryProducts(products, req.query).sellerQuery().categoryQuery().searchValue().priceQuery().ratingQuery().sortByPrice().countProducts(); 

            const result = new queryProducts(products, req.query).sellerQuery().categoryQuery().searchValue().ratingQuery().priceQuery().sortByPrice().skip().limit().getProducts();
